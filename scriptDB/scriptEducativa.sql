...
('Lenguajes de marcas', 'XML, JSON y tecnologías web básicas', 4, 'activa'),
...
('Lenguajes de marcas', 'XML y tecnologías de información', 32, 'activa'),
...
('Lenguajes de marcas', 'HTML, CSS, XML y tecnologías web', 18, 'activa'),
...
('Lucía', 'Morales', '89101112', '2006-06-15', 'Calle Norte 1300', '5556789', 'lucia.morales@email.com', '2025-01-23', NULL, 'luciamorales', '1a1dc91c907325c69271ddf0c944bc72', 'activo'),
('Andrés', 'Delgado', '90111213', '2007-01-27', 'Calle Oeste 1400', '5557890', 'andres.delgado@email.com', '2025-01-24', NULL, 'andresdelgado', '1a1dc91c907325c69271ddf0c944bc72', 'activo'),
('Valeria', 'Navarro', '01121314', '2005-08-08', 'Calle Central 1500', '5558901', 'valeria.navarro@email.com', '2025-01-25', NULL, 'valerianavarro', '1a1dc91c907325c69271ddf0c944bc72', 'activo');
...
(4, 4, 4.5, '2025-06-22', 'Recuperación'),
(5, 5, 4, '2025-06-25', 'Requiere mejorar'),
...
(12, 'economia', 1350.00, '2025-03-12', 'inactivo', 'Beca económica para estudiantes en riesgo social'),
(13, 'rendimiento', 850.00, '2025-03-13', 'inactivo', 'Beca por desempeño destacado en ciencias sociales');
...
-- insert estudiantes_eventos
INSERT INTO estudiantes_eventos (id_estudiante, id_evento, comentario, confirmado)
VALUES
(1, 1, 'Muy ilusionado por participar', TRUE),
(2, 1, 'Asistiré con mi grupo de amigos', TRUE),
(3, 1, 'En proceso de preparación', TRUE),
(4, 1, 'Necesito revisar el horario', TRUE),
(5, 1, 'Interesado pero pendiente de permiso', TRUE),
(6, 3, 'Equipo completo confirmado', TRUE),
(7, 3, 'Preparando material para la exposición', TRUE),
(8, 3, 'Entrenamiento en curso', TRUE),
(9, 3, 'Me interesa la charla técnica', TRUE),
(10, 10, 'Viaje escolar confirmado', TRUE),
(11, 10, 'Invitaré a mi familia', TRUE),
(12, 10, 'Pendiente de instrucciones', TRUE),
(13, 10, 'Entrenando ajedrez cada día', TRUE),
(14, 10, 'Preparando pósters informativos', TRUE),
(15, 10, 'Asistiré a la charla', TRUE),
(16, 1, 'Confirmado, iré solo', TRUE),
(17, 2, 'Formaremos equipo mixto', TRUE),
(1, 3, 'Interesado, pero confirmaré luego', TRUE),
(2, 4, 'Revisaré si puedo asistir', TRUE),
(3, 5, 'Me encantaría participar', TRUE),
(4, 6, 'Equipo en formación', TRUE),
(5, 7, 'Llevaré mi proyecto de pintura', TRUE),
(6, 8, 'Entrenando para la maratón', TRUE),
(7, 9, 'Asistiré con el grupo de robótica', TRUE),
(8, 10, 'Listo para la excursión', TRUE),
(9, 11, 'Invitaré a mis padres', TRUE),
(10, 12, 'Me falta confirmar transporte', TRUE),
(11, 13, 'Preparando estrategia de juego', TRUE),
