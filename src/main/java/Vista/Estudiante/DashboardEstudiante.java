...
//        panelBoton.add(btnAgregar);
    ...
    private void initGridPanel() {
        ...
        String[][] datos = {
                {"Nota media", String.valueOf(ControladorDashBoard.notaMediaAsignaturasEstudiante(VistaPrincipalEstudiante.usuarioLogeado)), "average"},
                {"Eventos por confirmar", String.valueOf(ControladorDashBoard.numEventosPorConfirmarEstudiante(VistaPrincipalEstudiante.usuarioLogeado)), "event"},
                {"Asignaturas suspensas", String.valueOf(ControladorDashBoard.numAsignaturasSuspensasEstudiante(VistaPrincipalEstudiante.usuarioLogeado)), "attendance"},
                {"Asignaturas aprobadas", String.valueOf(ControladorDashBoard.numAsignaturasAprobadasEstudiante(VistaPrincipalEstudiante.usuarioLogeado)), "attendance"},
                {"Faltas sin justificar", String.valueOf(ControladorDashBoard.numFaltasSinJustificarEstudiante(VistaPrincipalEstudiante.usuarioLogeado)), "history"},
                {"Faltas justificadas", String.valueOf(ControladorDashBoard.numFaltasJustificadasEstudiante(VistaPrincipalEstudiante.usuarioLogeado)), "history"}
        };
