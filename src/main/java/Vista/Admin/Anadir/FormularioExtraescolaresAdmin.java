    ...
    private void initEventos() {
        ...
        btnAceptar.addActionListener(e -> {
            ...
            try {
                ...
                new CustomDialog(null,"Éxito", "Actividad extraescolar registrada correctamente.","ONLY_OK").setVisible(true);
                dispose();
            } catch (Exception ex) {
                new CustomDialog(null,"Error", "Error al registrar la actividad extraescolar.","ONLY_OK").setVisible(true);
